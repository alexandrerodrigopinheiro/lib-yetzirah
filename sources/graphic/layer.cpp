...
ygl::graphic::layer::layer(const std::string& filename) :
	_data(0),
	_filename(std::string()),
	_visible(true),
	_wireframe(false),
...
bool ygl::graphic::layer::initialize(const std::string& filename)
{
...
void ygl::graphic::layer::destroy()
{
	glDeleteTextures(1, &this->_data);
	this->_animation.clear();
}

ygl::animation::tween* ygl::graphic::layer::tweening(const std::string& animation)
{
...
bool ygl::graphic::layer::animation(const std::string& animation, std::size_t timeline)
{
	auto it = this->_tweening.find(animation);
...
bool ygl::graphic::layer::animation(const std::string& animation, std::size_t timeline, std::size_t fps)
{
	auto it = this->_tweening.find(animation);
...
void ygl::graphic::layer::animation(const std::string& animation)
{
	auto it = this->_tweening.find(animation);
...
bool ygl::graphic::layer::sensible(const std::string& name, const ygl::math::surfaced& sensible)
{
...
const ygl::math::surfaced& ygl::graphic::layer::sensible(const std::string& name)
{
	auto it = this->_sensible.find(name);
...
void ygl::graphic::layer::draw(const ygl::math::pointd& position, const ygl::math::rotated& rotate, const ygl::math::sized& scale, const ygl::math::colord& color)
{
...
void ygl::graphic::layer::running()
{
	if (!this->_running)
	{
		return;
...
void ygl::graphic::layer::restart()
{
	if (!this->_animation.empty())
	{
		if (this->_tweening[this->_animation]->has_tweening())
...
bool ygl::graphic::layer::started()
{
	if (!this->_animation.empty())
	{
		if (this->_tweening[this->_animation]->has_tweening())
...
void ygl::graphic::layer::visible(bool visible)
{
	this->_visible = visible;
}

void ygl::graphic::layer::wireframe(bool wireframe)
{
	this->_wireframe = wireframe;
}

void ygl::graphic::layer::flip(const ygl::graphic::flip& flip)
{
	this->_flip = flip;
}

void ygl::graphic::layer::color(const ygl::math::colord& color)
{
	this->_color = color;
}

void ygl::graphic::layer::color(double r, double g, double b)
{
	this->_color.fill(r, g, b);
}

void ygl::graphic::layer::color_r(double r)
{
	this->_color.r(r);
}

void ygl::graphic::layer::color_g(double g)
{
	this->_color.g(g);
}

void ygl::graphic::layer::color_b(double b)
{
	this->_color.b(b);
}

void ygl::graphic::layer::opacity(double opacity)
{
	this->_opacity = ygl::math::clamp(opacity, 0.0, 100.0);
}

void ygl::graphic::layer::orientation(const ygl::graphic::orientation& orientation)
{
	this->_orientation = orientation;
}

void ygl::graphic::layer::pivot(const ygl::math::pointd& pivot)
{
	this->_pivot = pivot;
	this->resolve();
}

void ygl::graphic::layer::pivot(double x, double y, double z)
{
	this->_pivot.fill(x, y, z);
	this->resolve();
}

void ygl::graphic::layer::pivot_x(double x)
{
	this->_pivot.x(x);
	this->resolve();
}

void ygl::graphic::layer::pivot_y(double y)
{
	this->_pivot.y(y);
	this->resolve();
}

void ygl::graphic::layer::pivot_z(double z)
{
	this->_pivot.z(z);
	this->resolve();
}

void ygl::graphic::layer::position(const ygl::math::pointd& position)
{
	this->_position = position;
}

void ygl::graphic::layer::position(double x, double y, double z)
{
	this->_position.fill(x, y, z);
}

void ygl::graphic::layer::position_x(double x)
{
	this->_position.x(x);
}

void ygl::graphic::layer::position_y(double y)
{
	this->_position.y(y);
}

void ygl::graphic::layer::position_z(double z)
{
	this->_position.z(z);
}

void ygl::graphic::layer::scale(const ygl::math::sized& scale)
{
	this->_scale = scale;
}

void ygl::graphic::layer::scale(double w, double h, double l)
{
	this->_scale.fill(w, h, l);
}

void ygl::graphic::layer::scale_w(double w)
{
	this->_scale.w(w);
}

void ygl::graphic::layer::scale_h(double h)
{
	this->_scale.h(h);
}

void ygl::graphic::layer::scale_l(double l)
{
	this->_scale.l(l);
}

void ygl::graphic::layer::rotate(const ygl::math::rotated& rotate)
{
	this->_rotate = rotate;
}

void ygl::graphic::layer::rotate(double h, double p, double b)
{
	this->_rotate.fill(h, p, b);
}

void ygl::graphic::layer::rotate_h(double h)
{
	this->_rotate.h(h);
}

void ygl::graphic::layer::rotate_p(double p)
{
	this->_rotate.p(p);
}

void ygl::graphic::layer::rotate_b(double b)
{
	this->_rotate.b(b);
}

const std::string& ygl::graphic::layer::filename() const
{
	return this->_filename;
}

bool ygl::graphic::layer::visible() const
{
	return this->_visible;
}

bool ygl::graphic::layer::wireframe() const
{
	return this->_wireframe;
}

const ygl::graphic::flip& ygl::graphic::layer::flip() const
{
	return this->_flip;
}

const ygl::math::colord& ygl::graphic::layer::color() const
{
	return this->_color;
}

double ygl::graphic::layer::opacity() const
{
	return this->_opacity;
}

const ygl::graphic::orientation& ygl::graphic::layer::orientation() const
{
	return this->_orientation;
}

const ygl::math::pointd& ygl::graphic::layer::pivot() const
{
	return this->_pivot;
}

const ygl::math::pointd& ygl::graphic::layer::position() const
{
	return this->_position;
}

const ygl::math::sized& ygl::graphic::layer::scale() const
{
	return this->_scale;
}

const ygl::math::rotated& ygl::graphic::layer::rotate() const
{
	return this->_rotate;
}

const ygl::math::sized& ygl::graphic::layer::size() const
{
	return this->_size;
}

void ygl::graphic::layer::resolve()
{
