...
ygl::graphic::sprite::sprite(const std::string& filename, std::size_t colunms, std::size_t frames) :
	_data(0),
	_spot(1),
	_frames(frames),
	_filename(std::string()),
...
bool ygl::graphic::sprite::initialize(const std::string& filename, std::size_t colunms, std::size_t frames)
{
...
void ygl::graphic::sprite::destroy()
{
	glDeleteTextures(1, &this->_data);
	this->_animation.clear();
}

ygl::animation::tween* ygl::graphic::sprite::tweening(const std::string& animation)
{
...
bool ygl::graphic::sprite::animation(const std::string& animation, std::size_t timeline)
{
	auto it = this->_tweening.find(animation);
...
bool ygl::graphic::sprite::animation(const std::string& animation, std::size_t timeline, std::size_t fps)
{
	auto it = this->_tweening.find(animation);
...
void ygl::graphic::sprite::animation(const std::string& animation)
{
	auto it = this->_tweening.find(animation);
...
bool ygl::graphic::sprite::sensible(const std::string& name, const ygl::math::surfaced& sensible)
{
...
const ygl::math::surfaced& ygl::graphic::sprite::sensible(const std::string& name)
{
	auto it = this->_sensible.find(name);
...
void ygl::graphic::sprite::draw(const ygl::math::pointd& position, int spot, const ygl::math::rotated& rotation, const ygl::math::sized& scale, const ygl::math::colord& color)
{
...
void ygl::graphic::sprite::running()
{
	if (!this->_running)
	{
		return;
...
void ygl::graphic::sprite::restart()
{
	if (!this->_animation.empty())
	{
		if (this->_tweening[this->_animation]->has_tweening())
...
bool ygl::graphic::sprite::started()
{
	if (!this->_animation.empty())
	{
		if (this->_tweening[this->_animation]->has_tweening())
...
bool ygl::graphic::sprite::border()
{
	if (!this->_animation.empty())
	{
		if (this->_tweening[this->_animation]->has_tweening())
...
void ygl::graphic::sprite::spot(std::size_t spot)
{
	this->_spot = spot;
	this->resolve();
}

void ygl::graphic::sprite::visible(bool visible)
{
	this->_visible = visible;
}

void ygl::graphic::sprite::wireframe(bool wireframe)
{
	this->_wireframe = wireframe;
}

void ygl::graphic::sprite::flip(const ygl::graphic::flip& flip)
{
	this->_flip = flip;
}

void ygl::graphic::sprite::color(const ygl::math::colord& color)
{
	this->_color = color;
}

void ygl::graphic::sprite::color(double r, double g, double b)
{
	this->_color.fill(r, g, b);
}

void ygl::graphic::sprite::color_r(double r)
{
	this->_color.r(r);
}

void ygl::graphic::sprite::color_g(double g)
{
	this->_color.g(g);
}

void ygl::graphic::sprite::color_b(double b)
{
	this->_color.b(b);
}

void ygl::graphic::sprite::opacity(double opacity)
{
	this->_opacity = ygl::math::clamp(opacity, 0.0, 100.0);
}

void ygl::graphic::sprite::orientation(const ygl::graphic::orientation& orientation)
{
	this->_orientation = orientation;
}

void ygl::graphic::sprite::pivot(const ygl::math::pointd& pivot)
{
	this->_pivot = pivot;
	this->resolve();
}

void ygl::graphic::sprite::pivot(double x, double y, double z)
{
	this->_pivot.fill(x, y, z);
	this->resolve();
}

void ygl::graphic::sprite::pivot_x(double x)
{
	this->_pivot.x(x);
	this->resolve();
}

void ygl::graphic::sprite::pivot_y(double y)
{
	this->_pivot.y(y);
	this->resolve();
}

void ygl::graphic::sprite::pivot_z(double z)
{
	this->_pivot.z(z);
	this->resolve();
}

void ygl::graphic::sprite::position(const ygl::math::pointd& position)
{
	this->_position = position;
}

void ygl::graphic::sprite::position(double x, double y, double z)
{
	this->_position.fill(x, y, z);
}

void ygl::graphic::sprite::position_x(double x)
{
	this->_position.x(x);
}

void ygl::graphic::sprite::position_y(double y)
{
	this->_position.y(y);
}

void ygl::graphic::sprite::position_z(double z)
{
	this->_position.z(z);
}

void ygl::graphic::sprite::scale(const ygl::math::sized& scale)
{
	this->_scale = scale;
}

void ygl::graphic::sprite::scale(double w, double h, double l)
{
	this->_scale.fill(w, h, l);
}

void ygl::graphic::sprite::scale_w(double w)
{
	this->_scale.w(w);
}

void ygl::graphic::sprite::scale_h(double h)
{
	this->_scale.h(h);
}

void ygl::graphic::sprite::scale_l(double l)
{
	this->_scale.l(l);
}

void ygl::graphic::sprite::rotate(const ygl::math::rotated& rotate)
{
	this->_rotate = rotate;
}

void ygl::graphic::sprite::rotation(double h, double p, double b)
{
	this->_rotate.fill(h, p, b);
}

void ygl::graphic::sprite::rotation_h(double h)
{
	this->_rotate.h(h);
}

void ygl::graphic::sprite::rotation_p(double p)
{
	this->_rotate.p(p);
}

void ygl::graphic::sprite::rotation_b(double b)
{
	this->_rotate.b(b);
}

std::size_t ygl::graphic::sprite::spot() const
{
	return this->_spot;
}

std::size_t ygl::graphic::sprite::frames() const
{
	return this->_frames;
}

const std::string& ygl::graphic::sprite::filename() const
{
	return this->_filename;
}

bool ygl::graphic::sprite::visible() const
{
	return this->_visible;
}

bool ygl::graphic::sprite::wireframe() const
{
	return this->_wireframe;
}

const ygl::graphic::flip& ygl::graphic::sprite::flip() const
{
	return this->_flip;
}

const ygl::math::colord& ygl::graphic::sprite::color() const
{
	return this->_color;
}

double ygl::graphic::sprite::opacity() const
{
	return this->_opacity;
}

const ygl::graphic::orientation& ygl::graphic::sprite::orientation() const
{
	return this->_orientation;
}

const ygl::math::pointd& ygl::graphic::sprite::pivot() const
{
	return this->_pivot;
}

const ygl::math::pointd& ygl::graphic::sprite::position() const
{
	return this->_position;
}

const ygl::math::sized& ygl::graphic::sprite::scale() const
{
	return this->_scale;
}

const ygl::math::rotated& ygl::graphic::sprite::rotation() const
{
	return this->_rotate;
}

const ygl::math::sized& ygl::graphic::sprite::size() const
{
	return this->_size;
}

const ygl::math::matrixd& ygl::graphic::sprite::matrix() const
{
	return this->_matrix;
}

void ygl::graphic::sprite::resolve()
{
